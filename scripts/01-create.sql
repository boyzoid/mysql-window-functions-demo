...
insert into player (full_name, points, group_name) values ('Kum O''Reilly', 73.3, 'Group A');
...
insert into player (full_name, points, group_name) values ('Pat Danna', 183.45, 'Group B');
